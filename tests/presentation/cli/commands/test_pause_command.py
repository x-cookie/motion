...
class TestPauseCommand(BaseBatchCommandTest):
    ...
    @patch("presentation.cli.commands.pause.TaskController")
    def test_pause_in_progress_task_success(self, mock_controller_class):
        ...
        mock_controller.pause_task.return_value = paused_task
        ...
        mock_controller.pause_task.assert_called_once()
    ...
    @patch("presentation.cli.commands.pause.TaskController")
    def test_pause_already_pending_task(self, mock_controller_class):
        ...
        mock_controller = mock_controller_class.return_value
        mock_controller.pause_task.return_value = task
