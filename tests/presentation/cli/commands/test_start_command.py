...
class TestStartCommand(BaseBatchCommandTest):
    ...
    @patch("presentation.cli.commands.start.TaskController")
    def test_start_already_in_progress_task(self, mock_controller_class):
        ...
        mock_controller.start_task.return_value = task
