...
class TestGanttCellFormatter(unittest.TestCase):
    ...
    def test_build_workload_timeline(self):
        ...
        result = GanttCellFormatter.build_workload_timeline(daily_workload, start_date, end_date)
    ...
    def test_get_status_color(self):
        ...
        self.assertEqual(GanttCellFormatter.get_status_color(TaskStatus.PENDING), "yellow")
        self.assertEqual(GanttCellFormatter.get_status_color(TaskStatus.IN_PROGRESS), "bold blue")
        self.assertEqual(GanttCellFormatter.get_status_color(TaskStatus.COMPLETED), "bold green")
        self.assertEqual(GanttCellFormatter.get_status_color(TaskStatus.CANCELED), "bold red")
