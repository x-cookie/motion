...
class TestDateRangeFilter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Task with no dates
        self.task_no_dates = Task(id=4, name="No Dates", status=TaskStatus.PENDING, priority=1)
    ...
    def test_filter_with_both_dates(self):
        ...
        date_filter = DateRangeFilter(start_date=date(2025, 2, 1), end_date=date(2025, 2, 28))
        tasks = [self.task_jan, self.task_feb, self.task_mar]
    ...
    def test_filter_checks_all_date_fields(self):
        ...
        date_filter = DateRangeFilter(start_date=date(2025, 1, 1), end_date=date(2025, 1, 31))
    ...
    def test_filter_with_boundary_dates(self):
        ...
        date_filter = DateRangeFilter(start_date=date(2025, 1, 10), end_date=date(2025, 1, 15))
    ...
    def test_filter_with_no_matching_tasks(self):
        ...
        date_filter = DateRangeFilter(start_date=date(2025, 12, 1), end_date=date(2025, 12, 31))
        tasks = [self.task_jan, self.task_feb, self.task_mar]
    ...
    def test_init_requires_at_least_one_date(self):
        ...
        self.assertIn(
            "At least one of start_date or end_date must be provided", str(context.exception)
        )
