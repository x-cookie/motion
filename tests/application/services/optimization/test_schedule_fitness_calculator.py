...
class TestScheduleFitnessCalculator(unittest.TestCase):
    ...
    def test_calculate_fitness_empty_schedule(self):
        ...
        fitness = self.calculator.calculate_fitness([], {}, include_scheduling_bonus=False)
    ...
    def test_calculate_fitness_with_scheduling_bonus(self):
        ...
        self.assertAlmostEqual(fitness_with_bonus, fitness_without_bonus + expected_bonus, places=5)
    ...
    def test_deadline_penalty_zero_for_on_time_tasks(self):
        ...
        penalty = self.calculator._calculate_deadline_penalty([on_time_task, early_task])
    ...
    def test_workload_penalty_for_unbalanced_schedule(self):
        ...
        penalty_unbalanced = self.calculator._calculate_workload_penalty(unbalanced_allocations)
        penalty_balanced = self.calculator._calculate_workload_penalty(balanced_allocations)
