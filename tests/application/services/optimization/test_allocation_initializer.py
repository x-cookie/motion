...
class TestAllocationInitializer(unittest.TestCase):
    ...
    def test_includes_task_with_planned_schedule(self):
        ...
        allocations = self.initializer.initialize_allocations([task], force_override=False)
    ...
    def test_includes_fixed_tasks_even_with_force_override(self):
        ...
        allocations = self.initializer.initialize_allocations([task], force_override=True)
    ...
    def test_accumulates_hours_across_multiple_tasks(self):
        ...
        allocations = self.initializer.initialize_allocations([task1, task2], force_override=False)
