...
class TestEarliestDeadlineOptimizationStrategy(BaseOptimizationStrategyTest):
    ...
    def test_earliest_deadline_schedules_by_deadline_order(self):
        ...
        self.assertEqual(updated_task1.planned_start, datetime(2025, 10, 20, 9, 0, 0))  # Monday
        self.assertEqual(updated_task2.planned_start, datetime(2025, 10, 21, 9, 0, 0))  # Tuesday
    ...
    def test_earliest_deadline_handles_no_deadline(self):
        ...
        task2 = self.create_task("No Deadline", priority=100, estimated_duration=6.0, deadline=None)
    ...
    def test_earliest_deadline_ignores_priority_completely(self):
        ...
        assert updated_low is not None and updated_medium is not None and updated_high is not None
