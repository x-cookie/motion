...
class TestDependencyAwareOptimizationStrategy(BaseOptimizationStrategyTest):
    ...
    def test_dependency_aware_sorts_by_deadline_then_priority(self):
        ...
        self.assertEqual(updated_low_early.planned_start, datetime(2025, 10, 20, 9, 0, 0))
        self.assertEqual(updated_high_late.planned_start, datetime(2025, 10, 21, 9, 0, 0))
    ...
    def test_dependency_aware_handles_multiple_tasks(self):
        ...
        assert (
            updated_urgent is not None and updated_medium is not None and updated_high is not None
        )
