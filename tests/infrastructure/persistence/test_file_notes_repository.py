...
class TestFileNotesRepository(unittest.TestCase):
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_has_notes_returns_false_when_file_does_not_exist(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_has_notes_returns_false_when_file_is_empty(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_has_notes_returns_false_when_file_is_too_small(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_read_notes_returns_none_when_file_does_not_exist(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_read_notes_returns_content_when_file_exists(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_read_notes_returns_none_on_permission_error(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_read_notes_returns_none_on_unicode_decode_error(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_write_notes_raises_os_error_on_write_failure(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_write_notes_creates_parent_directory_if_needed(self, mock_xdg: MagicMock) -> None:
    ...
    @patch("infrastructure.persistence.file_notes_repository.XDGDirectories")
    def test_ensure_notes_dir_calls_xdg_get_notes_dir(self, mock_xdg: MagicMock) -> None:
