...
class StatisticsMapper:
    ...
    def from_statistics_result(statistics_result: StatisticsOutput) -> StatisticsViewModel:
        ...
        if statistics_result.time_stats:
            time_stats_vm = StatisticsMapper._map_time_statistics(statistics_result.time_stats)
    ...
    def _map_time_statistics(time_stats: TimeStatistics) -> TimeStatisticsViewModel:
        ...
        if time_stats.longest_task:
            longest_task_vm = StatisticsMapper._map_task_to_summary(time_stats.longest_task)

        shortest_task_vm = None
        if time_stats.shortest_task:
            shortest_task_vm = StatisticsMapper._map_task_to_summary(time_stats.shortest_task)
