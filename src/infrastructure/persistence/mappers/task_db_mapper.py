...
from infrastructure.persistence.database.models.task_model import TaskModel
...
class TaskDbMapper(TaskMapperInterface):
    ...
    def from_dict(self, data: dict[str, Any]) -> Task:
        ...
        daily_allocations = self._deserialize_date_dict(data.get("daily_allocations", "{}"))
        actual_daily_hours = self._deserialize_date_dict(data.get("actual_daily_hours", "{}"))
