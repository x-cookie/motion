...
class AllocationInitializer:
    ...
    def initialize_allocations(self, tasks: list[Task], force_override: bool) -> dict[date, float]:
        ...
        for task in tasks:
            ...
            task_daily_hours = task.daily_allocations or self.calculator.get_task_daily_hours(task)
