...
from motion.infrastructure.cli_config_manager import (
    CliConfig,
    GanttConfig,
    UiConfig,
    load_cli_config,
...
class TestCliConfig:
    ...
    def setup_and_teardown(self):
        ...
        original_env = {
            "motion_API_HOST": os.environ.get("motion_API_HOST"),
            "motion_API_PORT": os.environ.get("motion_API_PORT"),
            "motion_GANTT_WORKLOAD_COMFORTABLE_HOURS": os.environ.get(
                "motion_GANTT_WORKLOAD_COMFORTABLE_HOURS"
            ),
            "motion_GANTT_WORKLOAD_MODERATE_HOURS": os.environ.get(
                "motion_GANTT_WORKLOAD_MODERATE_HOURS"
            ),
        }
...
"""
            ...
            with patch(
                "motion.infrastructure.cli_config_manager.XDGDirectories.get_config_home",
...
"""
            ...
            os.environ["motion_API_HOST"] = "192.168.1.200"
            os.environ["motion_API_PORT"] = "4000"
...
"""
            ...
            os.environ["motion_GANTT_WORKLOAD_COMFORTABLE_HOURS"] = "5.0"
            os.environ["motion_GANTT_WORKLOAD_MODERATE_HOURS"] = "9.0"
