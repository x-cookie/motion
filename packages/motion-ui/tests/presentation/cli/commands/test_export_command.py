...
class TestExportCommand:
    ...
    @patch("motion.cli.commands.export.JsonTaskExporter")
    ...
    @patch("motion.cli.commands.export.CsvTaskExporter")
    ...
    @patch("motion.cli.commands.export.MarkdownTableExporter")
