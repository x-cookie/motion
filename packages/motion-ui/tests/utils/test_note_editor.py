...
from motion.utils.note_editor import (
...
class TestCreateTempNotesFile:
    ...
    @patch("motion.utils.note_editor.get_note_template")
...
class TestExecuteEdit:
    ...
    @patch("motion.utils.note_editor._edit_and_save_notes")
...
class TestEditTaskNote:
    ...
    @patch("motion.utils.note_editor._execute_edit")
    @patch("motion.utils.note_editor._prepare_temp_file")
    ...
    def test_uses_default_editor_runner_when_none(
        ...
        from motion.utils.note_editor import default_editor_runner
        ...
        mock_execute.assert_called_once()
        call_args = mock_execute.call_args[0]
        assert call_args[3] == default_editor_runner
...
class TestEditAndSaveNotes:
    ...
    @patch("motion.utils.note_editor.get_editor")
    def test_returns_true_when_content_changed(
        ...
        from motion.utils.note_editor import _edit_and_save_notes
