...
from motion.constants.gantt import MIN_GANTT_DISPLAY_DAYS
from motion_core.shared.config_loader import ConfigLoader
from motion_core.shared.config_manager import parse_time_value
from motion_core.shared.constants import (
    WORKLOAD_COMFORTABLE_HOURS,
    WORKLOAD_MODERATE_HOURS,
)
from motion_core.shared.constants.config_defaults import (
...
def load_cli_config() -> CliConfig:
    ...
    Environment variables:
        MOTION_API_HOST: API server hostname
        MOTION_API_PORT: API server port
        MOTION_API_KEY: API key for authentication
        MOTION_INPUT_DEADLINE_TIME: Default time for deadline input
        MOTION_INPUT_PLANNED_START_TIME: Default time for planned_start input
        MOTION_INPUT_PLANNED_END_TIME: Default time for planned_end input
        MOTION_GANTT_WORKLOAD_COMFORTABLE_HOURS: Comfortable workload threshold
        MOTION_GANTT_WORKLOAD_MODERATE_HOURS: Moderate workload threshold
        MOTION_GANTT_MIN_DISPLAY_DAYS: Minimum days to display in TUI Gantt chart
