...
def tags_command(
    ...
    Usage:
        motion tags              - List all tags with task counts
        motion tags ID           - Show tags for task ID
        motion tags ID tag1 tag2 - Set tags for task ID (replaces existing tags)
        motion tags -d TAG_NAME  - Delete a tag from the system
    """
