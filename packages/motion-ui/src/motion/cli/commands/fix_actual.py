...
def fix_actual_command(
    ...
    Examples:
        motion fix-actual 5 --start "2025-12-13 09:00:00"
        motion fix-actual 5 --start "2025-12-13 09:00:00" --end "2025-12-13 17:00:00"
        motion fix-actual 5 --duration 8
        motion fix-actual 5 --start "2025-12-01 09:00:00" --end "2025-12-03 18:00:00" --duration 16
        motion fix-actual 5 --start ""      # Clear actual_start
        motion fix-actual 5 --duration ""   # Clear actual_duration
    """
