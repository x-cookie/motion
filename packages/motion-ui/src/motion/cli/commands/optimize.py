...
Examples:
  motion optimize                          # Optimize all schedulable tasks (weekdays only)
  motion optimize 1 2 3                    # Optimize only tasks 1, 2, and 3
  motion optimize 5 --force                # Force optimize task 5
  motion optimize --include-all-days       # Include weekends and holidays
""",
)
