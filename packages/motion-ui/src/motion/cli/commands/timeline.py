...
from motion.renderers.rich_timeline_renderer import RichTimelineRenderer
...
\b
EXAMPLE:
  motion timeline                    # Show today's work times
  motion timeline -d 2026-01-29      # Show specific date
  motion timeline --date 2026-01-15  # Show specific date (long form)
""",
)
@click.option(
    "--date",
