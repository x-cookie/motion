...
from motion.utils.note_editor import edit_task_note
...
def note_command(
    ...
    - stdin/pipe: echo "content" | motion note 123
    - --content: motion note 123 --content "text"
    - --file: motion note 123 --file notes.md
    - $EDITOR: motion note 123 (default, opens editor)
