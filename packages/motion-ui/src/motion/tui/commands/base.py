...
from motion.tui.events import TasksRefreshed
...
class TUICommandBase(ABC):  # noqa: B024
    ...
    def __init__(self, app: "motionTUI", context: TUIContext):
        """Initialize the command.

        Args:
            app: The motionTUI application instance (for UI operations)
