...
class TUIWidget:
    ...
    @property
    def tui_app(self) -> "motionTUI":
        """Get typed reference to motionTUI app.

        Returns:
            The motionTUI application instance

        Note:
            This property assumes the widget is mounted in a motionTUI app.
