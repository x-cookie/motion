...
from motion.tui.widgets.base_widget import TUIWidget
from motion.tui.widgets.gantt_data_table import GanttDataTable
from motion.view_models.gantt_view_model import GanttViewModel
...
class GanttWidget(Vertical, TUIWidget):
    ...
    def _recalculate_gantt_for_width(self, display_days: int) -> None:
        ...
        from motion.tui.events import GanttResizeRequested
