...
from motion.tui.constants.keybindings import (
    BASIC_WORKFLOW,
    BUG_REPORT_INFO,
...
class HelpDialog(BaseModalDialog[None], ViNavigationMixin):
    ...
    def compose(self) -> ComposeResult:
        ...
        with Container(
            ...
            container.border_title = f"motion TUI v{__version__} - Getting Started"
            ...
            with TabbedContent(id="help-tabs"):
                ...
                with (
                    ...
                    yield Markdown(MOTION_OVERVIEW, classes="help-section")
