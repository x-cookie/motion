...
from motion.constants.colors import STATUS_COLORS_BOLD
from motion.formatters.date_time_formatter import DateTimeFormatter
from motion.tui.dialogs.base_dialog import BaseModalDialog
from motion.tui.widgets.audit_log_entry_builder import create_audit_log_table
from motion.tui.widgets.vi_navigation_mixin import ViNavigationMixin
from motion_core.shared.constants.formats import DATETIME_FORMAT
...
class TaskDetailDialog(BaseModalDialog[tuple[str, int] | None], ViNavigationMixin):
    ...
    def __init__(
        ...
        *args: Any,
        api_client: MotionApiClient | None = None,
        **kwargs: Any,
    ):
