...
if TYPE_CHECKING:
    ...
    from motion.infrastructure.cli_config_manager import CliConfig

from motion_client import WebSocketClient
...
from motion.services.task_data_loader import TaskDataLoader
from motion.tui.commands.factory import CommandFactory
from motion.tui.constants.command_mapping import ACTION_TO_COMMAND_MAP
from motion.tui.constants.ui_settings import (
    AUTO_REFRESH_INTERVAL_SECONDS,
    SORT_KEY_LABELS,
)
from motion.tui.context import TUIContext
from motion.tui.events import FilterChanged, GanttResizeRequested, TasksRefreshed
from motion.tui.palette.providers import (
...
from motion.tui.screens.main_screen import MainScreen
from motion.tui.selection import AppSelectionProvider
from motion.tui.services import ConnectionMonitor, TaskUIManager, WebSocketHandler
from motion.tui.state import ConnectionStatusManager, TUIState
from motion.tui.utils.css_loader import get_css_paths
...
class MotionTUI(App):  # type: ignore[type-arg]
    """Motion TUI application."""

    TITLE = f"Motion v{__version__}"
    ...
    def show_audit_logs(self) -> None:
        ...
        """
        from motion.tui.screens.audit_log_screen import AuditLogScreen
