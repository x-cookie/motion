...
from motion.cli.commands.add import add_command
from motion.cli.commands.add_dependency import add_dependency_command
from motion.cli.commands.audit_logs import audit_logs_command
from motion.cli.commands.cancel import cancel_command
from motion.cli.commands.done import done_command
from motion.cli.commands.export import export_command
from motion.cli.commands.fix_actual import fix_actual_command
from motion.cli.commands.gantt import gantt_command
from motion.cli.commands.note import note_command
from motion.cli.commands.optimize import optimize_command
from motion.cli.commands.pause import pause_command
from motion.cli.commands.remove_dependency import remove_dependency_command
from motion.cli.commands.reopen import reopen_command
from motion.cli.commands.restore import restore_command
from motion.cli.commands.rm import rm_command
from motion.cli.commands.show import show_command
from motion.cli.commands.start import start_command
from motion.cli.commands.stats import stats_command
from motion.cli.commands.table import table_command
from motion.cli.commands.tags import tags_command
from motion.cli.commands.timeline import timeline_command
from motion.cli.commands.update import update_command
from motion.cli.context import CliContext
from motion.console.rich_console_writer import RichConsoleWriter
from motion.infrastructure.cli_config_manager import load_cli_config
...
LAZY_SUBCOMMANDS: dict[str, str] = {
    "tui": "motion.cli.commands.tui.tui_command",
}


class MotionGroup(click.Group):
    ...
    def format_help(self, ctx: click.Context, formatter: Any) -> None:
        ...
        from motion.constants.ascii_art import (
            MOTION_ASCII_ART,
            MOTION_DESCRIPTION,
            MOTION_TAGLINE,
        )
        ...
        # Print ASCII art with italic styling
        for line in MOTION_ASCII_ART:
            console.print(line, style="italic")

        console.print(f"  {MOTION_TAGLINE}", style="bold yellow")
        console.print(f"  {MOTION_DESCRIPTION}", style="dim")
        console.print()
...
@click.version_option(version=__version__, prog_name="motion")
@click.option(
    "-H",
    "--host",
    type=str,
...
def cli(
    ...
    """Motion: Task management CLI tool with time tracking and optimization."""
    ...
    from motion_client import MotionApiClient

    api_client = MotionApiClient(
