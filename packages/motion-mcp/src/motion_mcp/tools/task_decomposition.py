...
def register_decomposition_tools(mcp: FastMCP, client: MotionApiClient) -> None:
    ...
    def decompose_task(
        ...
        Note: Motion does not have parent-child relationships.
...
def register_relationship_tools(mcp: FastMCP, client: MotionApiClient) -> None:
...
def register_notes_tools(mcp: FastMCP, client: MotionApiClient) -> None:
...
def register_tools(mcp: FastMCP, client: MotionApiClient) -> None:
    """Register all task decomposition and relationship tools.

    Args:
        mcp: FastMCP server instance
        client: Motion API client
    """
