...
from motion_mcp.config.mcp_config_manager import (
    McpApiConfig,
    McpConfig,
    McpServerConfig,
    load_mcp_config,
...
class TestMcpConfig:
    ...
    def test_default_values(self) -> None:
        ...
        assert config.server.name == "motion"
...
class TestLoadMcpConfig:
    ...
    def test_load_default_config_when_file_missing(self) -> None:
        ...
        with patch(
            "motion_mcp.config.mcp_config_manager.XDGDirectories.get_config_home"
        ) as mock_config_home:
...
""")
            ...
            with (
                ...
                patch.dict(
                    "os.environ",
                    {
                        "motion_API_HOST": "env-host",
                        "motion_API_PORT": "7777",
                    },
                ),
            ):
                mock_config_home.return_value = Path(tmpdir)
...
""")
            ...
            with patch(
                ...
                assert config.server.name == "motion"  # default
    ...
    def test_all_env_vars(self) -> None:
        ...
        with (
            ...
            patch.dict(
                ...
                {
                    "motion_API_HOST": "env-host",
                    "motion_API_PORT": "1234",
                    "motion_API_KEY": "env-key",
                    "motion_MCP_NAME": "env-name",
                    "motion_MCP_LOG_LEVEL": "WARNING",
                },
            ),
        ):
