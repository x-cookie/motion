...
class TestMain:
    ...
    def test_version_flag(self) -> None:
        ...
        with patch.object(sys, "argv", ["motion-mcp", "--version"]):
            with pytest.raises(SystemExit) as exc_info:
                from motion_mcp.main import main
    ...
    def test_main_creates_and_runs_server(self) -> None:
        ...
        with (
            patch.object(sys, "argv", ["motion-mcp"]),
            patch(
                "motion_mcp.main.create_mcp_server", return_value=mock_mcp
            ) as mock_create,
        ):
            from motion_mcp.main import main
    ...
    def test_main_parses_args(self) -> None:
        ...
        with (
            patch.object(sys, "argv", ["motion-mcp"]),
            patch("motion_mcp.main.create_mcp_server", return_value=mock_mcp),
        ):
            from motion_mcp.main import main
