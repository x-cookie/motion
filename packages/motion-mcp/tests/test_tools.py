...
from motion_core.application.dto.tag_statistics_output import TagStatisticsOutput
from motion_core.application.dto.task_detail_output import TaskDetailOutput
from motion_core.application.dto.task_dto import TaskDetailDto, TaskRowDto
...
def create_mock_client() -> MagicMock:
    """Create a mock motionApiClient with all required methods."""
    client = MagicMock()
    # motionApiClient has flat methods (no nested clients)
    # CRUD methods
...
class TestTaskCrudTools:
    ...
    def test_list_tasks_returns_formatted_response(self) -> None:
        ...
        from motion_mcp.tools import task_crud
...
class TestTaskLifecycleTools:
    ...
    def test_start_task_formats_response(self) -> None:
        ...
        from mcp.server.fastmcp import FastMCP
        from motion_mcp.tools import task_lifecycle
...
class TestTaskQueryTools:
    ...
    def test_get_statistics_formats_response(self) -> None:
        ...
        from mcp.server.fastmcp import FastMCP
        from motion_mcp.tools import task_query
...
class TestTaskDecompositionTools:
    ...
    def test_decompose_task_registers_without_error(self) -> None:
        ...
        from mcp.server.fastmcp import FastMCP
        from motion_mcp.tools import task_decomposition
    ...
    def test_build_subtask_tags(self) -> None:
        ...
        from motion_mcp.tools.task_decomposition import _build_subtask_tags
...
class TestTaskAuditTools:
    ...
    def test_list_audit_logs_returns_formatted_response(self) -> None:
        ...
        from mcp.server.fastmcp import FastMCP
        from motion_mcp.tools import task_audit
    ...
    def test_list_audit_logs_with_filters(self) -> None:
        ...
        from motion_core.application.dto.audit_log_dto import AuditLogListOutput
...
class TestTaskTagTools:
    ...
    def test_delete_tag_returns_formatted_response(self) -> None:
        ...
        from mcp.server.fastmcp import FastMCP
        from motion_mcp.tools import task_tags

        from motion_core.application.dto.delete_tag_output import DeleteTagOutput
