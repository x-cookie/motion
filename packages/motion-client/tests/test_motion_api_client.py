"""Tests for MotionApiClient facade."""
...
class TestMotionApiClientInit:
    """Test cases for MotionApiClient initialization."""

    @patch("motion_client.motion_api_client.BaseApiClient")
    @patch("motion_client.motion_api_client.TaskClient")
    @patch("motion_client.motion_api_client.LifecycleClient")
    @patch("motion_client.motion_api_client.RelationshipClient")
    @patch("motion_client.motion_api_client.QueryClient")
    @patch("motion_client.motion_api_client.AnalyticsClient")
    @patch("motion_client.motion_api_client.NotesClient")
    @patch("motion_client.motion_api_client.AuditClient")
...
class TestMotionApiClientProperties:
    """Test cases for MotionApiClient properties."""

    @pytest.fixture
    def client(self):
        """Create a MotionApiClient with mocked dependencies."""
        with patch("motion_client.motion_api_client.BaseApiClient") as mock_base:
            mock_base_instance = MagicMock()
            mock_base_instance.client = MagicMock()
            mock_base_instance.client_id = "test-client-id"
            mock_base_instance.api_key = "test-api-key"
            mock_base.return_value = mock_base_instance
            yield MotionApiClient()
...
class TestMotionApiClientLifecycle:
    """Test cases for MotionApiClient lifecycle methods."""
    ...
    def test_context_manager(self):
        ...
        with patch("motion_client.motion_api_client.BaseApiClient") as mock_base:
            ...
            with MotionApiClient() as client:
...
class TestMotionApiClientDelegation:
    """Test cases for MotionApiClient delegation methods."""
    ...
    def client(self):
        ...
        with (
            patch("motion_client.motion_api_client.BaseApiClient"),
            patch("motion_client.motion_api_client.TaskClient") as mock_task,
            patch(
                "motion_client.motion_api_client.LifecycleClient"
            ) as mock_lifecycle,
            patch(
                "motion_client.motion_api_client.RelationshipClient"
            ) as mock_relationship,
            patch("motion_client.motion_api_client.QueryClient") as mock_query,
            patch(
                "motion_client.motion_api_client.AnalyticsClient"
            ) as mock_analytics,
            patch("motion_client.motion_api_client.NotesClient") as mock_notes,
            patch("motion_client.motion_api_client.AuditClient") as mock_audit,
        ):
            client = MotionApiClient()
