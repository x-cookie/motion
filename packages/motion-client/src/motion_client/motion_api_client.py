"""Unified API client facade for motion server communication.
...
from motion_core.application.dto.gantt_output import GanttOutput
from motion_core.application.dto.get_task_by_id_output import TaskByIdOutput
from motion_core.application.dto.optimization_output import OptimizationOutput
from motion_core.application.dto.statistics_output import StatisticsOutput
...
from motion_core.domain.exceptions.task_exceptions import ServerConnectionError
...
class MotionApiClient:
    ...
    def __enter__(self) -> "motionApiClient":
