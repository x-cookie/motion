...
from motion_core.application.dto.task_dto import GanttTaskDto, TaskRowDto
from motion_core.application.queries.base import QueryService
from motion_core.application.sorters.task_sorter import TaskSorter

if TYPE_CHECKING:
    from datetime import date

    from motion_core.application.queries.filters.composite_filter import (
        CompositeFilter,
    )
    from motion_core.application.queries.filters.date_range_filter import (
        DateRangeFilter,
    )
    from motion_core.application.queries.filters.status_filter import StatusFilter
    from motion_core.application.queries.filters.tag_filter import TagFilter
...
class TaskQueryService(QueryService):
    ...
    def _get_remaining_filter(self, filter_obj: TaskFilter | None) -> TaskFilter | None:
        ...
        from motion_core.application.queries.filters.incomplete_filter import (
            IncompleteFilter,
        )
