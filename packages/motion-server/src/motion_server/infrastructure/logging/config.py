"""Logging configuration for the motion API server."""
...
def configure_logging(
    ...
    the motion_core and motion_server packages. It respects environment
    ...
    # Set log level for motion packages
    logging.getLogger("motion_core").setLevel(log_level)
    logging.getLogger("motion_server").setLevel(log_level)
