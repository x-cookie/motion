...
from motion_core.infrastructure.persistence.database.engine_factory import (
    create_sqlite_engine,
)
from motion_core.infrastructure.persistence.database.sqlite_audit_log_repository import (
    SqliteAuditLogRepository,
)
from motion_core.infrastructure.persistence.database.sqlite_notes_repository import (
...
from motion_core.shared.config_manager import Config, ConfigManager
from motion_server.api.context import ApiContext
from motion_server.config.server_config_manager import ServerConfig
from motion_server.infrastructure.logging.standard_logger import StandardLogger
...
def initialize_api_context(
    ...
    logger = logging.getLogger("motion_server.api.dependencies")
    ...
    query_logger = StandardLogger("motion_core.controllers.query_controller")
    lifecycle_logger = StandardLogger(
        "motion_core.controllers.task_lifecycle_controller"
    )
    relationship_logger = StandardLogger(
        "motion_core.controllers.task_relationship_controller"
    )
    analytics_logger = StandardLogger(
        "motion_core.controllers.task_analytics_controller"
    )
    crud_logger = StandardLogger("motion_core.controllers.task_crud_controller")
    audit_log_logger = StandardLogger("motion_core.controllers.audit_log_controller")
