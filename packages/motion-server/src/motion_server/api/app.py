...
from motion_core.shared.config_manager import ConfigManager
from motion_server import __version__
from motion_server.api.dependencies import initialize_api_context
from motion_server.api.middleware import LoggingMiddleware
...
from motion_server.config.server_config_manager import ServerConfigManager
from motion_server.infrastructure.logging.config import configure_logging
...
def create_app() -> FastAPI:
    ...
    async def root() -> dict[str, str]:
        """Root endpoint."""
        return {"message": "motion API", "version": __version__}
