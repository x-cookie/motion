"""DTO for fixing actual start/end timestamps."""
...
class FixActualTimesInput:
    """Request data for fixing actual timestamps.

    Used to correct actual_start and actual_end after the fact,
    for historical accuracy. Uses Ellipsis (...) as sentinel to
    distinguish "not provided" from None (explicit clear).
