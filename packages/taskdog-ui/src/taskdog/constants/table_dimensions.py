...
TASK_TABLE_EST_WIDTH = 7
TASK_TABLE_ACTUAL_WIDTH = 7
TASK_TABLE_PLANNED_START_WIDTH = 14  # MM-DD HH:MM or 'YY MM-DD HH:MM
TASK_TABLE_PLANNED_END_WIDTH = 14  # MM-DD HH:MM or 'YY MM-DD HH:MM
TASK_TABLE_ACTUAL_START_WIDTH = 14  # MM-DD HH:MM or 'YY MM-DD HH:MM
TASK_TABLE_ACTUAL_END_WIDTH = 14  # MM-DD HH:MM or 'YY MM-DD HH:MM
TASK_TABLE_DEADLINE_WIDTH = 14  # Shortened: MM-DD HH:MM or 'YY MM-DD HH:MM
TASK_TABLE_ELAPSED_WIDTH = 14
TASK_TABLE_TAGS_WIDTH = 20
TASK_TABLE_FLAGS_WIDTH = 4  # Combined Fixed + Note indicators
